...
public class NumberPickerDialog extends AlertDialog implements OnClickListener {
    ...
    public NumberPickerDialog(Context context,
        ...
        setButton(DialogInterface.BUTTON_POSITIVE, context.getText(R.string.okay_action), this);
        setButton(DialogInterface.BUTTON_NEGATIVE, context.getText(R.string.cancel_action),
